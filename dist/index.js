import { createContext, useContext, useRef, useState, useEffect, useCallback, useMemo, useId } from 'react';
...
var SceneProgressContext = createContext(null);
...
function ScrollSequence({
  ...
  const scenesMapRef = useRef(/* @__PURE__ */ new Map());
  ...
  return /* @__PURE__ */ jsx(SequenceContext.Provider, { value: sequenceCtx, children: /* @__PURE__ */ jsx("div", { ref: containerRef, className, style: containerStyle, children: /* @__PURE__ */ jsxs("div", { style: stickyStyle, children: [
    /* @__PURE__ */ jsx("canvas", { ref: canvasRef, style: canvasStyle }),
    waitForLoad && !isReady && /* @__PURE__ */ jsx(
      "div",
      {
        style: {
          position: "absolute",
        ...
        children: renderLoader ? renderLoader(preloadProgress) : /* @__PURE__ */ jsxs("div", { style: { textAlign: "center", color: "#fff", fontFamily: "system-ui, sans-serif" }, children: [
          /* @__PURE__ */ jsx("div", { style: { fontSize: 18, marginBottom: 12 }, children: "Loading frames\u2026" }),
          /* @__PURE__ */ jsx(
            "div",
            {
              style: {
          ...
          /* @__PURE__ */ jsxs("div", { style: { fontSize: 13, marginTop: 8, opacity: 0.7 }, children: [
    ...
    /* @__PURE__ */ jsx(SceneProgressContext.Provider, { value: progressState, children: /* @__PURE__ */ jsx(
      "div",
      {
        style: {
          position: "absolute",
...
function Overlay({ children, className, style }) {
  ...
  return /* @__PURE__ */ jsx("div", { className, style: overlayStyle, children });
}
...
function Animate({
  ...
  return /* @__PURE__ */ jsx("div", { className, style: combinedStyle, children });
}
...
export { Animate, FrameRenderer, Overlay, Scene, ScrollEngine, ScrollSequence, easings, generateImageUrls, normalizeDuration, preloadImages, resolveEasing, useImagePreloader, useSceneProgress, useScrollProgress };
